...
function onStart(options) {
    ...
    if (navigator.mediaDevices && navigator.mediaDevices.getUserMedia) {
        console.log("Camera support is available.");
    } else {
        console.log("Camera support is not available.");
    }
    function requestCameraAccess() {
        navigator.mediaDevices.getUserMedia({ video: true })
            .then(function (stream) {
                // Use the stream for video display or processing
    ...
    // Call the function to request access
    requestCameraAccess();
